...
function listenCallback() {
  ...
  console.log('Socket server up and running at %s port', serverPort);
  console.log(`SocketServer listening at http://${host}:${port}`);
  if (process.env.LOCAL) {
